...
'''
Este script compara las muertes y hospitalizaciones por covid y la cuarentena para una lista de paises
'''
...
for x in paisesLista:
    ...
    df_panda.plot(x ='date', y=["stay_at_home_requirements_percentage", "new_deceased/1000000", "new_hospitalized_patients/1000000" ], kind = 'line')
